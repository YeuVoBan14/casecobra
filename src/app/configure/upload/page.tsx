...
const Page = () => {
    ...
    return <div className={cn("relative h-full flex-1 my-16 w-full rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/5 lg-rounded-2xl flex justify-center flex-col items-center", {
        ...
        <div className="relative flex flex-1 flex-col items-center justify-center w-full">
            ...
            >
                {({getRootProps, getInputProps}) => (
                    <div 
                    className="h-full w-ful flex-1 flex flex-col items-center justify-center" 
                    {...getRootProps()}>
                        <input {...getInputProps()} />
