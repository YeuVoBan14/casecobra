...
function Review({imgSrc, className, ...props}: ReviewProps){
    ...
    return <div className={cn('animate-fade-in rounded-[2.25rem] bg-white p-6 opacity-0 shadow-xl shadow-slate-900/5', 
        className)} style={{animationDelay}} 
        {...props} aria-busy
        ><Phone imgSrc={imgSrc} /></div>
}
...
export function Reviews(){
    return <MaxWidthWrapper className="relative max-w-5xl">
        <img src="/what-people-are-buying.png" className="absolute select-none hidden xl:block -left-32 top-1/3" aria-hidden="true" alt="" />
        <ReviewGrid/>
    </MaxWidthWrapper>
}